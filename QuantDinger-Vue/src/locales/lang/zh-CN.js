...
const locale = {
  ...
  'user.login.infos': 'TradeLens 是一个 AI 多智能体股票分析辅助工具，不具备证券投资咨询资质。平台中的所有分析结果、评分、参考意见均由 AI 基于历史数据自动生成，仅供学习、研究与技术交流使用,不构成任何投资建议或决策依据。股票投资存在市场风险、流动性风险、政策风险等多种风险，可能导致本金损失。用户应基于自身风险承受能力独立决策，使用本工具产生的任何投资行为及其后果由用户自行承担。市场有风险，投资需谨慎。',
  ...
  'user.login.legal.content': 'TradeLens 是一个 AI 多智能体股票分析辅助工具，不具备证券投资咨询资质。平台中的所有分析结果、评分、参考意见均由 AI 基于历史数据自动生成，仅供学习、研究与技术交流使用，不构成任何投资建议或决策依据。股票投资存在市场风险、流动性风险、政策风险等多种风险，可能导致本金损失。用户应基于自身风险承受能力独立决策，使用本工具产生的任何投资行为及其后果由用户自行承担。市场有风险，投资需谨慎。',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR 和 MT5 属于外挂类实盘接口，需要本地部署运行 TradeLens，不支持云端 SaaS 模式。请确保您已在本地安装并配置相关交易软件（TWS/IB Gateway 或 MT5 终端）。',
  ...
  'settings.commercialLicense.body': 'TradeLens 仅供个人学习与研究使用。若您计划将本系统用于任何形式的商业化运营（包括但不限于对外提供 SaaS 服务、二次销售、代客交易、付费咨询、私募服务等），必须事先获得官方书面商业授权，否则我们将依法追究相应法律责任。',
  ...
  'profile.exchange.openAccountPromo': 'TradeLens 专属开户，享最高 20% 返佣',
  ...
  'trading-assistant.editor.docsIntroDesc': '这里展示的是 TradeLens 脚本策略可用的常用 API 与生命周期说明，方便你边写边查。',
